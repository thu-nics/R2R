...
class ModelController:
    def __init__(self, comparison_model: str = 'reference', api_url_main: str = "http://localhost:30000", api_url_reference: str = "http://localhost:30000", api_key: str = "api_key", request_timeout: int = 6000):
        """Initialize models for generation control using API requests instead of direct model access"""
        # API configuration
        ...
        # Load models paths for tokenizer and config
        ...
        # Store model configuration instead of initializing engines
        ...
        logger.info("ModelController initialized successfully with API endpoints")
    ...
    def _make_api_request(self, api_url: str, input_ids_list: List[List[int]], sampling_params: dict, custom_logit_processor: str = None) -> List[Dict]:
        """Make API request to generate endpoint"""
        headers = {
    ...
    def generate_continuation(
        ...
        model_type: str,
        past_key_values: Optional[Tuple] = None,  # Not needed with API but kept for compatibility
        ...
        """
        Generate continuation from given context using API requests with token IDs.
        ...
        Args:
            ...
            past_key_values: Not used in API implementation
        ...
        Returns:
            List of dictionaries, each containing:
                ...
                - past_key_values: None (not used in API)
    ...
    def generate_continuation_single(
        ...
        """
        Generate continuation for a single mismatch using API requests.
    ...
    def shutdown(self):
        """Shutdown method for API compatibility - no resources to clean up"""
