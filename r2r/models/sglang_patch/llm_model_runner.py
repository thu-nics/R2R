...
class LLMModelRunner(ModelRunner):
    ...
    def init_device_graphs(self):
        ...
        self.graph_runner = (
            LLMCudaGraphRunner(self) if not _is_npu else NPUGraphRunner(self)
        )
    ...
    def _forward_raw(
        ...
        can_run_graph = bool(is_cuda_graph(forward_batch.forward_mode) and self.graph_runner and self.graph_runner.can_run(forward_batch))
